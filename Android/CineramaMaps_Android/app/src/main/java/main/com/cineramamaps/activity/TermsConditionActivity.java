...
//        });
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
            final AlertDialog.Builder builder = new AlertDialog.Builder(TermsConditionActivity.this);
            builder.setMessage("");
                ...
                if (response.isSuccessful()) {
                    try {
                        ...
                        if (error.equals("1")) {
                            ...
                            termsvalue_en = oo.getString("term");
                             termsvalue_sp = oo.getString("term_sp");
