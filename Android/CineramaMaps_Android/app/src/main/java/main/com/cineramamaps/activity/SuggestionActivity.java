...
import main.com.cineramamaps.databinding.ActivitySuggestionBinding;
...
public class SuggestionActivity extends AppCompatActivity {
        ...
        binding.postitembut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (binding.messageEt.getText().toString() == null || binding.messageEt.getText().toString().equalsIgnoreCase("")) {
                    Toast.makeText(SuggestionActivity.this, getResources().getString(R.string.writesomething), Toast.LENGTH_LONG).show();
                } else {
                    sendFeedbakc();
                }
    ...
    private void sendFeedbakc() {
        ...
        ApiCall.get().Create().sendSuggestion(session.getUserID(), binding.nameEt.getText().toString(), binding.messageEt.getText().toString()).enqueue(new Callback<ResponseBody>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (object.getString("status").equals("1")) {
                            Toast.makeText(SuggestionActivity.this, getResources().getString(R.string.wewillcontactsoon), Toast.LENGTH_LONG).show();
                            finish();
                        }
                    } catch (Exception e) {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                Toast.makeText(SuggestionActivity.this, getResources().getString(R.string.serverproblem), Toast.LENGTH_LONG).show();
