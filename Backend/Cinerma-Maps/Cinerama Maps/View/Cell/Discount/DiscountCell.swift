...
//    @IBOutlet weak var stackVw: UIStackView!
    ...
    private func setupSkeletonUI() {
        ...
        textDiscount.lastLineFillPercent = 70
...
//        stackVw.skeletonCornerRadius = 8
    ...
    override func layoutSubviews() {
        ...
        offer_CodeAndPercent.roundCorners(corners: [.topLeft, .topRight], radius: 8)
        textDiscount.roundCorners(corners: [.bottomLeft, .bottomRight], radius: 8)
    }
}
